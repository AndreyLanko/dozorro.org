                            ...
                            @foreach($block->data['tenders'] as $tender)
                                ...
                                @if($item)
                                    <div class="sb-list-item">
                                        ...
                                        <div class="sb-list-item__row">
                                            <a href="/tender/{{ $item->tenderID }}/" class="sb-list-item__stat">{{ $item->status }}</a>
                                            <a href="/tender/{{ $item->tenderID }}/" class="sb-list-item__comments">{{ $tender->comments }}</a>
                                        </div>
                                    </div>
                                @endif
                            @endforeach
                            <div class="c-list-card__link-wrap">
                                <a href="/tender/search/">Всі тендери</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            @foreach($block->data['reviews'] as $item)
                                @if(isset($item->data) && $item->data)
                                    <div class="sb-list-item">
                                        ...
                                        <div class="sb-list-item__row">
                                            <a href="/tender/{{ $item->data->tenderID }}/" class="sb-list-item__stat">{{ $item->data->status }}</a>
                                            <a href="/tender/{{ $item->data->tenderID }}/" class="sb-list-item__comments">{{ $item->data->total_reviews }}</a>
                                        </div>
                                    </div>
                                @endif
                            @endforeach
